...
deps_optional = {
    ...
    'lib/mcu/st/cmsis_device_f4': ['https://github.com/STMicroelectronics/cmsis_device_f4.git',
                                   ...
                                   'stm32f4'],
    'lib/mcu/st/cmsis_device_f7': ['https://github.com/STMicroelectronics/cmsis_device_f7.git',
    ...
    'lib/mcu/st/stm32f4xx_hal_driver': ['https://github.com/STMicroelectronics/stm32f4xx_hal_driver.git',
                                        ...
                                        'stm32f4'],
    'lib/mcu/st/stm32f7xx_hal_driver': ['https://github.com/STMicroelectronics/stm32f7xx_hal_driver.git',
                                        '7cc013f79487235bb8c0fa961edda0680a0f04e0',
                                        'stm32f7'],
